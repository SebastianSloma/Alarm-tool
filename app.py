...
period = Label(frame_body, text='period', height=1,
               font=('Modern 10 bold'), bg='white')
period.place(x=300, y=50)

c_period = Combobox(frame_body, width=2, font=('modern 15'))
c_period['values'] = ('AM', 'PM')
c_period.current(0)
c_period.place(x=300, y=80)

selected = IntVar()

radio1 = Radiobutton(frame_body, font=('modern 10 bold'),
                     value=1, text='Activate', bg='white')
radio1.place(x=140, y=130)
window.mainloop()
